    ...
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="mt-5">
          ...
          <p className="text-3xlmt-3 text-gray-900">$140</p>
          ...
          <div className="flex mt-6 items-center justify-between space-x-2">
            <button className="flex-1 bg-orange-500 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 font-medium hover:bg-orange-700">
              Talk to seller
            </button>
